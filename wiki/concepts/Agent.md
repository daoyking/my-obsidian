...
| **生成式 UI** | 输出可交互组件而非文本，见 [[生成式UI]] | `generative_ui_agents` 7 |
...
**观察**：形态之间不互斥，而是叠加（一个语音 Agent 可以同时是 RAG + 多 Agent + 常驻）。真正的架构决策是「**这个任务需要叠加哪几层**」，而非「用不用 Agent」。

## 相关概念

- [[ReAct]] · [[Harness工程]] · [[上下文工程]] · [[MCP]] · [[记忆系统]] · [[多模态大模型]] · [[Agent安全]] · [[思维链]] · [[Coding-Agent]] · [[常驻Agent]] · [[生成式UI]] · [[RAG]] · [[Agent评估]]
